<div style="padding:10px 0 10px 60px">
    <form id="yovim-admin-friendlink-form-edit" name="yovim-admin-friendlink-form-edit" method="post">
        <table width="100%" class="tbl-line">
            ...
            <tr>
                <td align="right">&nbsp;</td>
                <td>
                    <input name="id" type="hidden" class="easyui-validatebox" value="">
                    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="$('#yovim-admin-friendlink-form-edit').submit();">Submit</a>
                    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="$('#yovim-admin-friendlink-form-edit')[0].reset();">Clear</a>
                </td>
            </tr>
        </table>
    </form>
